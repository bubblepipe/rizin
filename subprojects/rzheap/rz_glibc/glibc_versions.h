...
static inline RzGlibcChunkLayout rz_glibc_chunk_layout(ut8 ptr_size) {
	return (RzGlibcChunkLayout){
		.prev_size = 0,
		.size = ptr_size,
		.fd = ptr_size * 2,
		.bk = ptr_size * 3,
...
typedef struct rz_glibc_heap_info_layout_t {
	...
	ut32 mprotect_size;
	ut32 struct_size;
} RzGlibcHeapInfoLayout;

static const RzGlibcHeapInfoLayout rz_glibc_heap_info_layout_234_64 = {
	.ar_ptr = 0,
	.prev = 8,
	.size = 16,
	.mprotect_size = 24,
...
static const RzGlibcHeapInfoLayout rz_glibc_heap_info_layout_235_64 = {
	.ar_ptr = 0,
	.prev = 8,
	.size = 16,
	.mprotect_size = 24,
...
static const RzGlibcHeapInfoLayout rz_glibc_heap_info_layout_234_32 = {
	.ar_ptr = 0,
	.prev = 4,
	.size = 8,
	.mprotect_size = 12,
...
static const RzGlibcHeapInfoLayout rz_glibc_heap_info_layout_235_32 = {
	.ar_ptr = 0,
	.prev = 4,
	.size = 8,
	.mprotect_size = 12,
...
static inline RzGlibcHeapInfoLayout rz_glibc_get_heap_info_layout(
	int glibc_version, ut8 ptr_size) {
	if (ptr_size == 8) {
...
static const RzGlibcTcacheLayout rz_glibc_tcache_layout_226_64 = {
	.counts = 0,
	.entries = 64,
	.struct_size = 576,
	.count_type_size = 1,
...
static const RzGlibcTcacheLayout rz_glibc_tcache_layout_230_64 = {
	.counts = 0,
	.entries = 128,
	.struct_size = 640,
	.count_type_size = 2,
...
static const RzGlibcTcacheLayout rz_glibc_tcache_layout_242_64 = {
	.counts = 0,
	.entries = 152,
	.struct_size = 760,
	.count_type_size = 2,
...
static const RzGlibcTcacheLayout rz_glibc_tcache_layout_226_32 = {
	.counts = 0,
	.entries = 64,
	.struct_size = 320,
	.count_type_size = 1,
...
static const RzGlibcTcacheLayout rz_glibc_tcache_layout_230_32 = {
	.counts = 0,
	.entries = 128,
	.struct_size = 384,
	.count_type_size = 2,
...
static const RzGlibcTcacheLayout rz_glibc_tcache_layout_242_32 = {
	.counts = 0,
	.entries = 152,
	.struct_size = 456,
	.count_type_size = 2,
...
static inline RzGlibcTcacheLayout rz_glibc_get_tcache_layout(
	int glibc_version, ut8 ptr_size) {
	if (ptr_size == 8) {
		if (glibc_version >= RZ_GLIBC_VERSION_2_42) {
			return rz_glibc_tcache_layout_242_64;
		} else if (glibc_version >= RZ_GLIBC_VERSION_2_30) {
			return rz_glibc_tcache_layout_230_64;
		} else if (glibc_version >= RZ_GLIBC_VERSION_2_26) {
...
typedef struct rz_glibc_tcache_entry_layout_t {
	...
	ut32 struct_size;
	bool has_key;
} RzGlibcTcacheEntryLayout;

// 225 has no tcache_entry
static const RzGlibcTcacheEntryLayout rz_glibc_tcache_entry_layout_226_64 = {
	.next = 0,
	.key = 0,
	.struct_size = 8,
	.has_key = false
...
static const RzGlibcTcacheEntryLayout rz_glibc_tcache_entry_layout_229_64 = {
	.next = 0,
	.key = 8,
	.struct_size = 16,
	.has_key = true
...
static const RzGlibcTcacheEntryLayout rz_glibc_tcache_entry_layout_226_32 = {
	.next = 0,
	.key = 0,
	.struct_size = 4,
	.has_key = false
...
static const RzGlibcTcacheEntryLayout rz_glibc_tcache_entry_layout_229_32 = {
	.next = 0,
	.key = 4,
	.struct_size = 8,
	.has_key = true
...
static inline RzGlibcTcacheEntryLayout rz_glibc_get_tcache_entry_layout(
	int glibc_version, ut8 ptr_size) {
	if (ptr_size == 8) {
