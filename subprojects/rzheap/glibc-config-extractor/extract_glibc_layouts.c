...
int main(void) {
	...
	/* RzGlibcChunkLayout                                           */
	/* ------------------------------------------------------------ */
	printf("static const RzGlibcChunkLayout rz_glibc_chunk_layout_%d_%s = {\n",
		GLIBC_SRC_VERSION_ID, bits);
	...
	/* ------------------------------------------------------------ */
	printf("static const RzGlibcHeapInfoLayout rz_glibc_heap_info_layout_%d_%s = {\n",
		GLIBC_SRC_VERSION_ID, bits);
	...
	/* ------------------------------------------------------------ */
	printf("static const RzGlibcTcacheEntryLayout rz_glibc_tcache_entry_layout_%d_%s = {\n",
		GLIBC_SRC_VERSION_ID, bits);
	...
	/* RzGlibcTcacheLayout                                        */
	/* ------------------------------------------------------------ */
	printf("static const RzGlibcTcacheLayout rz_glibc_tcache_layout_%d_%s = {\n",
		GLIBC_SRC_VERSION_ID, bits);
	// printf("// RzGlibcTcacheLayout %s { count_size = %zu, ptr_size = %zu }\n",
...
#else
	printf("// RzGlibcTcacheEntryLayout: not present (glibc < 2.26)\n");
	printf("// RzGlibcTcacheLayout: not present (glibc < 2.26)\n\n");
#endif
	printf("};\n\n");
